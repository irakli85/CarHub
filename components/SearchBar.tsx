...
const SearchButton = ({otherClases} : {otherClases: string}) => (
  <button type="submit" className={`-ml-3 z-10 ${otherClases}`}>
    <Image src='/magnifying-glass.svg' width={40} height={40} alt="glass" className="object-contain"/>
  </button>
)
...
const SearchBar = ({setManufacturer, setModel}) => {
  ...
  return (
    <form className='searchbar' onSubmit={handleSearch}>
        ...
        <div className="searchbar__item">
            <Image src='/model-icon.png' width={25} height={25} alt="model" className="absolute w-[20px] h-[20px] ml-4"/>
